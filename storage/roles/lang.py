lang = {
    'en': {
        ...
        'role_user_added': "My trainer was to lazy to train me how to validate, but role {} should be added to {}.",
        'role_user_doesnt_have': "User {} doesn't have role {}.",
        'role_user_removed': "My trainer was to lazy to train me how to validate, but role {} should be removed from {}.",
