lang = {
    'en': {
        ...
        'role_user_no_masterrole': "The role {} has no master role, so I won't let you do this.",
        'role_user_already': "User {} has role {} already.",
        'role_user_added': "My trainer was to lazy to teach me how to validate, but role {} should be added to {}.",
        'role_user_doesnt_have': "User {} doesn't have role {}.",
        'role_user_removed': "My trainer was to lazy to teach me how to validate, but role {} should be removed from {}.",
        ...
        'role_add_created': "My trainer was to lazy to teach me how to validate, but the role {} should be created with color {} now.",
        'role_del': "My trainer was to lazy to teach me how to validate, but the role {} should be deleted now.",
